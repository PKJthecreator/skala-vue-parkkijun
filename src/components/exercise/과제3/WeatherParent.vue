...
// ── 1. 반응형 상태 관리 (요구사항 1: WeatherParent가 모든 반응형 데이터 유지) ────
// composition/과제2/WeatherComposition.vue와 동일한 데이터 구조를 그대로 재사용
...
<template>
  <div class="practice-section">
    <div class="weather-parent">
      <h2 class="parent-title"><span>🌤️</span> 날씨 (컴포넌트 분리)</h2>

      <!-- 요구사항 2, 6: BaseDashboardCard의 slot으로 SearchBar/UnitToggle을 주입 -->
